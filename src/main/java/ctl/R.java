...
public class R {
    ...
    public ModelAndView viewVideo(String zbmc,String zbms,String sfzh,
                                  String zbtx,String zxrs,
                                  String sp,String fjh,
                                  String jbs,String gzs) throws UnsupportedEncodingException {
